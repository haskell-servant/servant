...
instance
  (KnownSymbol sym, HasForeignType lang ftype t, HasForeign lang ftype api)
...
instance
  (KnownSymbol sym, HasForeignType lang ftype [t], HasForeign lang ftype sublayout)
...
instance
  (ct ~ JSON, HasForeignType lang ftype a, ReflectMethod method)
...
instance
  (KnownSymbol sym, HasForeignType lang ftype (RequiredArgument mods a), HasForeign lang ftype api)
...
instance
  (Elem JSON list, HasForeignType lang ftype a, HasForeign lang ftype api)
...
instance
  (KnownSymbol path, HasForeign lang ftype api)
...
instance
  (GenerateList ftype start, GenerateList ftype rest)
