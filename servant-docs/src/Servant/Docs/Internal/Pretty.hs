...
type family Pretty (api :: k) :: k where
  ...
  Pretty (Query cs r) = Query (Pretty cs) r
  Pretty (GetPartialContent cs r) = GetPartialContent (Pretty cs) r
  Pretty (QueryPartialContent cs r) = QueryPartialContent (Pretty cs) r
  ...
  Pretty (QueryResetContent cs r) = QueryResetContent (Pretty cs) r
  ...
  Pretty (QueryNonAuthoritative cs r) = QueryNonAuthoritative (Pretty cs) r
  ...
  Pretty (QueryAccepted cs r) = QueryAccepted (Pretty cs) r
